...
async def typewriter(typew):
    ...
    await typew.edit("`Aku Sayang S`")
    await typew.edit("`Aku Sayang Sa`")
    await typew.edit("`Aku Sayang Sal`")
    await typew.edit("`Aku Sayang Sals`")
    await typew.edit("`Aku Sayang Salsa`")
    await typew.edit("`Aku Sayang Salsab`")
    await typew.edit("`Aku Sayang Salsabi`")
    await typew.edit("`Aku Sayang Salsabil`")
    await typew.edit("`Aku Sayang Salsabila`")
    sleep(1)
    await typew.edit("`I LOVE YOU 💞`")


@register(outgoing=True, pattern='^.lopulin(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("`Sa Cuma Mau Bilang`")
    ...
    await typew.edit("`Aku Sayan`")
    await typew.edit("`Aku Sayang`")
    await typew.edit("`Aku Sayang L`")
    await typew.edit("`Aku Sayang Li`")
    await typew.edit("`Aku Sayang Lin`")
    await typew.edit("`Aku Sayang Lind`")
